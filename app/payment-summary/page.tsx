  ...
  return (
    <div className="flex flex-col min-h-screen justify-between bg-[#f7f9fb]">
      ...
      <div className="flex-grow px-4 py-10 flex flex-col items-center">
        {/* Page Title */}
        <h2 className="text-2xl font-semibold text-center mb-2" style={{ color: primaryDark }}>
          Payment Summary
        </h2>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 w-full max-w-xl mb-8">
          <h3 className="text-lg font-semibold mb-4 text-center" style={{ color: primaryDark }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {paymentTypes.map((type) => (
              <div
                ...
                style={{
                  borderColor: selectedType === type.key ? primaryColor : "#ccc",
                }}
              >
                <div
                  className="w-5 h-5 mx-auto rounded-full mb-2"
                  style={{
                    backgroundColor: selectedType === type.key ? primaryColor : "#e5e7eb",
                  }}
                />
        ...
        >
          ...
          <p className="text-3xl font-extrabold mt-2" style={{ color: primaryColor }}>
